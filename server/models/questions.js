...
exports.getQuestions = (params, cb) => {
  const queryString =
  `SELECT
...
exports.createQuestion = (params, cb) => {
...
exports.markQuestionHelpful = (params, cb) => {
  const queryString = `
  UPDATE questions
...
exports.markQuestionReported = (params, cb) => {
  const queryString = `
  UPDATE questions
